...
Markdown 모드에서 연속 빈 줄이 시각적 여백으로 반영됩니다. 일반 Markdown에서는 빈 줄이 몇 개든 하나의 문단 간격으로 축소되지만, Mark Slide Down에서는 빈 줄 수만큼 추가 여백이 생성됩니다.

```
첫 번째 문단


세 번째 줄 (빈 줄 2개 → 여백 1줄 추가)



다섯 번째 줄 (빈 줄 3개 → 여백 2줄 추가)
```
